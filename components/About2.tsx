...
const About2 = ({contents, dark}: any) => {
  return (
  <div className={`min-h-[90vh] flex items-center justify-center flex-col pt-5 max-md:pt-14 max-md:pb-8 md:px-[8rem] ${dark ? "bg-[url(/bgGrid.jpeg)] bg-contain text-[#627EF3]":`${contents.background}`}`}>
     {/* <div>
     ...
     <div className=' flex flex-wrap px-4 items-center max-md:flex-col-reverse'>
        <div className='w-full px-12 lg:w-1/2 flex flex-col items-start justify-start py-8'>
            ...
            <p className={`pb-4 font-montserrat text-2xl max-md:text-xl  ${dark ? "text-white":"text-black"}`}>
                {contents.content}
            </p>
        </div>    
