...
const Accordion = () => {
  return (
    <section className="relative z-20 overflow-hidden pt-20 pb-20 px-5 lg:pt-[120px] bg-[#323232] lg:pb-[90px] shadow">
  ...
  return (
    <div className="mb-8 w-full  rounded-lg border border-[#F3F4FE] transition ease-in-out delay-150 md:hover:-translate-y-1 hover:scale-100  bg-white p-4 sm:p-8 lg:px-6 xl:px-8">
      ...
      >
        ...
        <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center md:hover:animate-spin-slow rounded-lg bg-dark bg-opacity-5 text-primary">
          <svg
            className={` ${
              active ? "rotate-180" : ""
            }`}
